...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__order_summary_order_summary__ = __webpack_require__(324);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_http__ = __webpack_require__(232);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var Service = /** @class */ (function () {
    ...
    Service.prototype.getOrders = function (filter) {
        ...
        return new Promise(function (resolve) {
            _this.http.get(_this.config.setUrl('GET', '/wp-json/wc/v3/orders?', filter), _this.config.options).map(function (res) { return res.json(); }).subscribe(function (data) {
                ...
                // console.log(data);
                _this.orders = [];
                _this.reorder.forEach(function (values) {
                    if (values.customer_id == filter.customer_id) {
                        _this.orders.push(values);
    ...
    Service.prototype.getProducts = function () {
        ...
        this.http.get(this.config.setUrl('GET', '/wp-json/wc/v3/products?', false), this.config.options).map(function (res) { return res.json(); }).subscribe(function (data) {
            // console.log(data);
            _this.reproducts = data;
            _this.products = [];
            _this.reproducts.forEach(function (values) {
                if (values.catalog_visibility == "visible") {
                    values.categories.forEach(function (valuesa) {
                        if (valuesa.id != 210) {
                            _this.check = true;
                        }
                        else {
            ...
            _this.http.get(_this.config.setUrl('GET', '/wp-json/wc/v3/products?', _this.filter), _this.config.options).map(function (res) { return res.json(); }).subscribe(function (data) {
                ...
                data.forEach(function (values) {
                    if (values.catalog_visibility == "visible") {
                        ...
                        if (_this.check == true) {
                            _this.loadmore.push(values);
                        }
                    }
                });
                _this.handleMore(_this.loadmore);
                resolve(true);
            });
        });
    };
...
var OrderSummary = /** @class */ (function () {
    function OrderSummary(nav, service, params, functions, values, myModal) {
        this.nav = nav;
        this.service = service;
        this.params = params;
        this.functions = functions;
...
var TermsCondition = /** @class */ (function () {
    ...
    TermsCondition = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"D:\Documents\komuniti4u\src\pages\checkout\terms-condition\terms-condition.html"*/'<ion-header>\n\n   <ion-navbar color="header">\n\n      <ion-title>{{"TermsConditions" | translate}}</ion-title>\n\n   </ion-navbar>\n\n</ion-header>\n\n<ion-content padding class="terms-condition">\n\n   <div class="terms">\n\n      <b>Welcome to Komuniti4u!</b>\n\n      <br><br>\n\n      Thanks for using our products and website. These terms and conditions outline the rules and regulations for the use of Komuniti, located at komuniti4u.com\n\n      <br><br>\n\n      By accessing our website, you are agreeing to these terms. Please read them carefully. Do not continue to use Komuniti4u if you do not agree to take all of the terms and conditions stated on this page.\n\n      <br><br>\n\n      The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and all Agreements: Client refers to you, the person log on this website and compliant to the Komuniti’s terms and conditions. Us refers to our Company. Us refers to both the Client and ourselves. All terms refer to the offer, acceptance and consideration of payment necessary to undertake the process of our assistance to the Client in the most appropriate manner for the express purpose of meeting the Client’s needs in respect of provision of the Komuniti’s stated services, in accordance with and subject to, prevailing law of Malaysia. Any use of the above terminology or other words in the singular, plural, capitalization and/or he/she or they, are taken as interchangeable and therefore as referring to same.\n\n      <br><br>\n\n      <b>Cookies</b>\n\n      <br><br>\n\n      We employ the use of cookies. By accessing Komuniti4u, you agreed to use cookies in agreement with the Komuniti Privacy Policy.\n\n      <br><br>\n\n      Most interactive websites use cookies to let us retrieve the user’s details for each visit. Cookies are used by our website to enable the functionality of certain areas to make it easier for people visiting our website.\n\n      <br><br>\n\n      <b>License</b>\n\n      <br><br>\n\n      Unless otherwise stated, Komuniti and/or its licensors own the intellectual property rights for all material on komuniti4u. All intellectual property rights are reserved. You may access this from Komuniti4u for your own personal use subjected to restrictions set in these terms and conditions.\n\n      <br><br>\n\n      You must not:\n\n      <ul>\n\n         <li>Republish material from Komuniti4u</li>\n\n         <li>Sell, rent or sub-license material from Komuniti4u</li>\n\n         <li>Reproduce, duplicate or copy material from Komuniti4u</li>\n\n         <li>Redistribute content from Komuniti4u</li>\n\n         <li>This Agreement shall begin on the date hereof.</li>\n\n      </ul>\n\n      <br><br>\n\n      Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. Komuniti does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of Komuniti, its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, Komuniti shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.\n\n      <br><br>\n\n      Komuniti reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.\n\n      <br><br>\n\n      You warrant and represent that:\n\n      <ul>\n\n         <li>You are entitled to post the Comments on our website and have all necessary licenses and consents to do so.</li>\n\n         <li>The Comments do not invade any intellectual property right, including without limitation copyright, patent or trademark of any third party.</li>\n\n         <li>The Comments do not contain any defamatory, libellous, offensive, indecent or otherwise unlawful material which is an invasion of privacy.</li>\n\n         <li>The Comments will not be used to solicit or promote business or custom or present commercial activities or unlawful activity.</li>\n\n      </ul>\n\n      You hereby Komuniti a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.\n\n      <br><br>\n\n      <b>Hyperlinking to our Content</b>\n\n      <br><br>\n\n      The following organizations may link to our Website without prior written approval:\n\n      <ul>\n\n         <li>Government agencies</li>\n\n         <li>Search engines</li>\n\n         <li>News organizations and</li>\n\n         <li>Online directory distributors may link to our Website in the same manner as they hyperlink to the Websites of other listed businesses.</li>\n\n         <li>System wide Accredited Businesses except soliciting non-profit organizations</li>\n\n      </ul>\n\n      <br><br>\n\n      <b>Frames</b>\n\n      <br><br>\n\n      Without prior approval and written permission, you may not create frames around our Webpages that alter in any way the visual presentation or appearance of our Website.\n\n      <br><br>\n\n      <b>Content Liability</b>\n\n      <br><br>\n\n      We shall not be hold responsible for any content that appears on your Website. You agree to protect and defend us against all claims that is rising on your Website. No link(s) should appear on any Website that may be interpreted as libellous, obscene or criminal, or which infringes, otherwise violates, or advocates the infringement or other violation of, any third party rights.\n\n      <br><br>\n\n      <b>Reservation of Rights</b>\n\n      <br><br>\n\n      We reserve the right to request that you remove all links or any particular link to our Website. You approve to immediately remove all links to our Website upon request. We also reserve the right to amen these terms and conditions and it’s linking policy at any time. By continuously linking to our Website, you agree to be bound to and follow these linking terms and conditions.\n\n      <br><br>\n\n      <b>Removal of links from our website</b>\n\n      <br><br>\n\n      If you find any link on our Website that is offensive for any reason, you are free to contact and inform us any moment. We will consider requests to remove links but we are not obligated to or so or to respond to you directly.\n\n      <br><br>\n\n      We do not ensure that the information on this website is correct, we do not warrant its completeness or accuracy; nor do we promise to ensure that the website remains available or that the material on the website is kept up to date.\n\n      <br><br>\n\n      <b>Disclaimer</b>\n\n      <br><br>\n\n      To the maximum extent permitted by applicable law, we exclude all representations, warranties and conditions relating to our website and the use of this website. Nothing in this disclaimer will:\n\n      <ul>\n\n         <li>limit or exclude our or your liability for death or personal injury</li>\n\n         <li>limit or exclude our or your liability for fraud or fraudulent misrepresentation</li>\n\n         <li>limit any of our or your liabilities in any way that is not permitted under applicable law or </li>\n\n         <li>exclude any of our or your liabilities that may not be excluded under applicable law.</li>\n\n      </ul>\n\n      <br><br>\n\n      The limitations and prohibitions of liability set in this Section and elsewhere in this disclaimer: (a) are subject to the preceding paragraph; and (b) govern all liabilities arising under the disclaimer, including liabilities arising in contract, in tort and for breach of statutory duty.\n\n      <br><br>\n\n      As long as the website and the information and services on the website are provided free of charge, we will not be liable for any loss or damage of any nature.\n\n      <br><br>\n\n      <b>TERMS OF SALE</b>\n\n      <br><br>\n\n      By submitting your order or accepting or using products, you acknowledge that you agree to these terms in their entirety.\n\n      <br><br>\n\n      <b>Orders, Acceptance and Cancellation.</b> Your order is an offer to buy. Komuniti may send an order confirmation email to acknowledge receipt your order, but Komuniti does not accept your order until we send you notice that the Product has shipped. Komuniti may process payment for and ship parts of an order separately. Komuniti reserves the right at any time, even after we send you a confirmation email, to decline or cancel your order or to limit order quantities for any reasons, including errors or suspected fraud.\n\n      <br><br>\n\n      <b>Pricing and Availability.</b> Prices and promotions are subject to change. Komuniti strives to communicate accurate pricing and product information, but errors may occur. In the unlikely event that an error impacts your order, or a Product ordered is no longer available, we will either contact you for instructions or cancel your order.\n\n      <br><br>\n\n      <b>PAYMENT TERMS</b>\n\n      <br><br>\n\n      You agree that you will pay for all products purchase through the websites. Komuniti may charge your payment method for any products purchased and for any additional amounts (including any taxes and late fees, as applicable) that may be accrued by or in connection with your Account. You are responsible for the timely payment for all fees and for providing Komunitii with a valid payment method for payment of all fees.\n\n      <br><br>\n\n      Your total price will include the price of the product plus any applicable tax; such tax is based on the bill-to address and the tax rate in effect at the time you download the product.\n\n      <br><br>\n\n      Prices for products offered via the websites may change at any time, and the websites do not provide price protection or refunds in the event of a price reduction or promotional offering.\n\n      <br><br>\n\n      If a product becomes unavailable following transaction but prior to download, your sole remedy is a refund. If technical problems prevent or unreasonably delay delivery of your product, your exclusive and sole remedy is either replacement or refund of the price paid, as determined by Komuniti.\n\n      <br><br>\n\n      <b>SHIPPING & DELIVERY</b>\n\n      <br><br>\n\n      Product title passes to you when the Product ships. You are responsible for inspecting the package(s) upon delivery and must note any visible damage on the proof of delivery (POD) or other delivery receipt the carrier asks you to sign. Komuniti is not responsible for any visible shipping damages not noted on the delivery receipt.\n\n      <br><br>\n\n   </div>\n\n</ion-content>\n\n'/*ion-inline-end:"D:\Documents\komuniti4u\src\pages\checkout\terms-condition\terms-condition.html"*/
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_service_product_service__ = __webpack_require__(149);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_service_values__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_service_functions__ = __webpack_require__(26);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__search_search__ = __webpack_require__(151);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_facebook_ngx__ = __webpack_require__(375);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AccountLogin = /** @class */ (function () {
    function AccountLogin(nav, service, functions, values, platform, oneSignal, fb) {
        var _this = this;
        this.nav = nav;
        this.service = service;
        this.functions = functions;
    ...
    //Social Media Login
    AccountLogin.prototype.facebookLogin = function () {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_service_values__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_service_functions__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__order_details_order_details__ = __webpack_require__(379);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_service_wishlist_service__ = __webpack_require__(381);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_service_values__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_service_functions__ = __webpack_require__(26);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_account_address_address__ = __webpack_require__(376);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_account_order_details_order_details__ = __webpack_require__(379);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_account_orders_orders__ = __webpack_require__(378);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_account_register_register__ = __webpack_require__(152);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__pages_account_wishlist_wishlist__ = __webpack_require__(380);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pages_cart_cart__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__pages_checkout_billing_address_form_billing_address_form__ = __webpack_require__(234);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__pages_checkout_order_summary_order_summary__ = __webpack_require__(324);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__pages_search_search__ = __webpack_require__(151);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__pages_notifications_notifications__ = __webpack_require__(174);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__providers_service_cart_service__ = __webpack_require__(233);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__providers_service_wishlist_service__ = __webpack_require__(381);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_34__providers_service_product_service__ = __webpack_require__(149);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_38__providers_pipe_pipe__ = __webpack_require__(713);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_39__ionic_native_photo_viewer__ = __webpack_require__(327);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_40__ionic_native_call_number__ = __webpack_require__(714);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_41__ionic_native_email_composer__ = __webpack_require__(383);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_42__ionic_native_app_rate__ = __webpack_require__(382);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_43__ionic_native_social_sharing__ = __webpack_require__(150);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_44__angular_common_http__ = __webpack_require__(715);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_47__ngx_translate_http_loader__ = __webpack_require__(716);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_48__ionic_native_onesignal__ = __webpack_require__(73);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_49__ionic_native_http__ = __webpack_require__(232);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_50__ionic_native_facebook_ngx__ = __webpack_require__(375);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_50__ionic_native_facebook_ngx__["a" /* Facebook */],
                // GooglePlus,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_service_cart_service__ = __webpack_require__(233);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_service_values__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_service_functions__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__checkout_billing_address_form_billing_address_form__ = __webpack_require__(234);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_service_values__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_service_functions__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__md5__ = __webpack_require__(693);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_photo_viewer__ = __webpack_require__(327);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_social_sharing__ = __webpack_require__(150);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__notifications_notifications__ = __webpack_require__(174);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__account_register_register__ = __webpack_require__(152);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pages_account_address_address__ = __webpack_require__(376);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__pages_account_orders_orders__ = __webpack_require__(378);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__pages_account_register_register__ = __webpack_require__(152);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__pages_account_wishlist_wishlist__ = __webpack_require__(380);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__pages_product_product__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__pages_post_post__ = __webpack_require__(95);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__ionic_native_app_rate__ = __webpack_require__(382);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__ionic_native_social_sharing__ = __webpack_require__(150);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__ionic_native_email_composer__ = __webpack_require__(383);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__ionic_native_native_storage__ = __webpack_require__(129);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
