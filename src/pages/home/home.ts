...
import { MemberpromoPage } from '../memberpromo/memberpromo';
...
export class Home {
    ...
    pet: string = "mallitem";
    constructor(public toastCtrl: ToastController, public nav: NavController, public service: Service, public myModal: ModalController ,public values: Values) {
        this.items = [];
        this.options = [];
